...
- (void)layoutSubviews {
	...
	//CGSize labelSize = [label.texsizeWithFont:label.font];
    
    NSDictionary* attribs = @{NSFontAttributeName:label.font};
    CGSize labelSize = [label.text sizeWithAttributes:attribs];
    ...
    // attribs = @{NSFontAttributeName:label.font , NSCon};
    ...
    //CGSize *check=[detailsLabel.text siz]
